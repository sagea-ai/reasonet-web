  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-2xl px-4">
      <div className="bg-neutral-300/10 backdrop-blur-xl dark:bg-gray-900/90 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg">
        {isLoading && (
          <div className="h-0.5 bg-gradient-to-r from-sky-500 to-purple-500 animate-pulse"></div>
        )}
        ...
        <div className="flex items-end gap-3 p-3">
          ...
          <button
            ...
            className="p-3 bg-sky-500 hover:bg-sky-600 text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-shrink-0"
          >
            {isLoading ? (
